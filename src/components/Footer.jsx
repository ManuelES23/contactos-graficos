...
export default function Footer() {
  ...
  return (
    <footer style={{ backgroundColor: "#0D2260" }}>
      {/* Green separator line */}
      <div className='h-1 w-full' style={{ backgroundColor: "#2ECC40" }} />
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10'>
          ...
          <div className='lg:col-span-1'>
            ...
            >
              ...
              />
              <span className='hidden items-center gap-2 font-heading font-bold text-lg text-white'>
                <span
            ...
            <div className='flex gap-3'>
              {socials.map((s) => (
                <a
                  ...
                  className='w-9 h-9 rounded-lg flex items-center justify-center transition-colors duration-200 text-white/60 hover:text-white'
            ...
            <ul className='space-y-4'>
              {[
                ...
                },
                {
                  ...
                  text: "info@contactosgraficos.com",
                },
                {
                  icon: (
                    <svg
                ...
                >
                  <span style={{ color: "#2ECC40" }}>{c.icon}</span>
                  {c.text}
                </li>
              ))}
            </ul>
